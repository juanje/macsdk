...
# Note: Only if you really need to add custom fields to the response.
# from pydantic import Field
#
# class AgentResponse(BaseAgentResponse):
#     """Custom response model for vm-agent.
#
#     Example fields for vm-agent:
#     """
#
